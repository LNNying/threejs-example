function SixPointedStar(								//声明绘制用物体对象所属类
	...
	for(angle;angle<360;angle=angle+60)
	{
		...
		//第二个点
		vertexarray[i*18+3]=0.2*Math.cos(angle*Math.PI/180);
		vertexarray[i*18+4]=0.2*Math.sin(angle*Math.PI/180);
		vertexarray[i*18+5]=z;
		//第三个点
		vertexarray[i*18+6]=0.5*Math.cos((angle+30)*Math.PI/180);
		vertexarray[i*18+7]=0.5*Math.sin((angle+30)*Math.PI/180);
		...
		//第二个点
		vertexarray[i*18+12]=0.5*Math.cos((angle+30)*Math.PI/180);
		vertexarray[i*18+13]=0.5*Math.sin((angle+30)*Math.PI/180);
		vertexarray[i*18+14]=z;
		//第三个点
		vertexarray[i*18+15]=0.2*Math.cos((angle+60)*Math.PI/180);
		vertexarray[i*18+16]=0.2*Math.sin((angle+60)*Math.PI/180);
